...
print(combined_plot)
ggsave("TablesFigures/Figure A1 - WM Performance Raincloud_plot.jpeg",dpi=600, w= 9, h = 4)
```
...
# Display the combined plot
print(combined_plot)
ggsave("TablesFigures/Figure A2 - ADES Raincloud_plot.jpeg",dpi=600, w= 9, h = 4)
```
