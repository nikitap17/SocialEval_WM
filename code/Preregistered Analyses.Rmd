...
ggplot(bf_collect3, aes(x = sample_size, y = logmean, group = Hypothesis,
  ...
  scale_color_manual(values = c(c2_high,c3)) +  # Orange color for H0 and dark green for H1
  scale_fill_manual(values = c(c2_high, c3)) +
...
ggplot(bf_collect_er3, aes(x = sample_size, y = logmean, group = Hypothesis,
  ...
  scale_color_manual(values = c(c2_high, c3)) +
  scale_fill_manual(values = c(c2_high, c3)) +# Orange color for H0 and dark green for H1
