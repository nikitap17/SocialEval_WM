...
combined_plot <- (errors_plot | rt_plot) +
...
print(combined_plot)
ggsave("TablesFigures/Figure A1 - WM Performance Raincloud_plot.jpeg",dpi=600, w= 10, h = 5)
```
...
# Display the combined plot
print(combined_plot)
ggsave("TablesFigures/Figure A2 - ADES Raincloud_plot.jpeg",dpi=600, w= 10, h = 5)
```
